    ...
    <div className="mx-auto max-w-screen-2xl">
      <div className="flex flex-col justify-start mx-8 md:mx-12 mt-12 md:mt-20 md:mb-20">
        ...
        <ProjectContent
          ...
          iconPaths={[
            "/icons/bootstrap_logo.svg",
            "/icons/plotly_logo.svg",
            "/icons/python_logo.svg",
            "/icons/celery_logo.png",
        ...
        <ProjectContent
          ...
          iconPaths={[
            "/icons/tailwind_logo.svg",
            "/icons/three-js_logo.png",
            "/icons/react_logo.png",
            "/icons/next-js_logo.png",
            "/icons/javascript_logo.png",
          ]}
          description={
            <p className="text-sm md:text-base lg:text-lg">
              Shit about the project goes here. I don't what to write so I'm
...
function CoursesContent({}) {
  const courses = [
    ...
    },
    {
      ...
      description: "Python, Machine Learning, pandas, sklearn",
    },
    {
      code: "CIVENG 191",
      title: "Civil and Environmental Engineering Systems Analysis",
      description: "MATLAB, Linear, Dynamic, and Nonlinear Programs",
    },
    {
      code: "CIVENG 190",
      title: "Electric Mobility Engineering",
      description: "EV's, Batteries",
    },
    {
      code: "CIVENG 167",
